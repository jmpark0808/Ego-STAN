...
from net.blocks import HeatMap, HM2Pose



class xRNetHM2Pose_noconv(pl.LightningModule):
    ...
    def pose_loss(self, pose_pred, pose_label):
        """
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss_3d_pose = self.pose_loss(pose, p3d)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        val_loss_3d_pose = self.pose_loss(pose, p3d)
        # update 3d pose loss
