...
class xREgoPoseSeqHMDirect(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.resnet_transformer = ResNetTransformerCls(seq_len=self.seq_len*12*12, dim=512, depth=3, heads=8, mlp_dim=1024, dim_head=64, dropout=self.dropout, emb_dropout=self.dropout)
