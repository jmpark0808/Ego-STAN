...
pose_dict = {
    'map_concat': FeatureConcat2Pose(),
    'branch_concat': FeatureBranch2Pose(),
...
class xREgoPoseSeqHMDirect(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        # Direct regression from heatmap and feature heatmap
        self.fhms2pose = FeatureBranch2Pose()
    ...
    def forward(self, x):
        ...
        # fhms = batch_size x 15 x 47 x 47

        p3d = self.fhms2pose(hms, dms)
