...
class xREgoPoseSeqHM(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        shceduler = {'scheduler': torch.optim.lr_scheduler.LinearLR(optimizer, start_factor=0.00000001, end_factor=1.0, total_iters=int(self.hm_train_steps/self.batch_size)),
                        'name': 'learning_rate',
                        'interval':'step',
                        'frequency': 1}
