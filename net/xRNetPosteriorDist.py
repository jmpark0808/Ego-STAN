...
class xREgoPosePosteriorDist(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.example_input_array = (torch.rand((1, 16, 47, 47)), torch.rand((1, 16, 30)))

        # Generator that produces the HeatMap
        self.hm2pose = HM2PoseDist()
    ...
    def training_step(self, batch, batch_idx):
        ...
        img, p2d, p2d_1d, p3d, action, img_path = batch
        p2d = p2d.cuda()
        p3d = p3d.cuda()
        p2d_1d = p2d_1d.cuda()
        # forward pass
        pose = self.forward(p2d, p2d_1d)
