...
class MocapH36MCropHM(BaseDataset):
    ...
    def __init__(self, *args, heatmap_type='baseline', heatmap_resolution=[47, 47], image_resolution=[368, 368], sigma=3, protocol = 'p1_train', w2c=True, sr=1, **kwargs):
    ...
    def __getitem__(self, index):
        ...
        p3d_unnorm = np.matmul(np.linalg.inv(intrinsic_matrix), uv1.T).T
        p3d = np.copy(p3d_unnorm)
