...
if __name__ == '__main__':
    ...
    model.feature_heatmaps.resnet101.apply(weight_init) #Change 2, model.heatmap -> model.feature_heatmaps
    if args.load_resnet:
        model.feature_heatmaps.resnet101.load_state_dict(torch.load(args.load_resnet))
    model.feature_heatmaps.update_resnet101()
    model.feature_heatmaps.heatmap_deconv.apply(weight_init)
    model.feature_heatmaps.featuremap_deconv.apply(weight_init) #Addition 1 -> new deconv for uncertainty
