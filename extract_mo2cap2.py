    ...
    if(dict_args["dataset_type"] == "TEST"):
        ...
        for fpath in os.listdir(olek_dir_path):
            ...
            if frame_idx in dict_olek.keys():
                ...
                io.write_json(os.path.join(olek_json_path, "{0}{1:04}.json".format(fpath[:-8], frame_idx)), dict_json_info)
        ...
        for fpath in os.listdir(weipeng_dir_path):
            ...
            if frame_idx in dict_weipeng.keys():
                ...
                io.write_json(os.path.join(weipeng_json_path, "{0}{1:04}.json".format(fpath[:-8], frame_idx)), dict_json_info)
        ...
        for chunk_path in os.listdir(dataset_dir):
            ...
            # Opening the h5py file to make the images and json files
